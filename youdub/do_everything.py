    ...
    for retry in range(max_retries):
        try:
            ...
            if folder is None:
                ...
                return True
            db.execute(f"INSERT INTO `transport_job_des`(`tj_id`, `video_id`, `video_url`, `title`, `remark`, `state`) VALUES  "
                       f"({transport_job['tj_id']},'{info['id']}','{info['webpage_url']}','{info['title']}','{info['description']}',1)")
