...
# 补充处理数据
def auto_pub():
    # asyncio.run(add_account(Param(shop_user_id='4388011692',cookie="_did=web_585941606113FCC9; did=web_zpi1vrdlvp919pwizapvm6x8xyj4bawg; bUserId=1000288877268; userId=4388011692; sid=kuaishou.shop.b; kuaishou.shop.b_st=ChJrdWFpc2hvdS5zaG9wLmIuc3QSoAF0ts-7p7N3ye45PrrodJk5-4wtvINP8UIlyY08htc00OE6pMc6pAuBrcopjshReq7v6yZsFm0py_lOzUk4YjZ9AgR433wRe0YeYkist6utT0y_QHM_wrWhWwrjfdTGDWr_PDIYv2NMto50yI5Kydb_JvfWP0HgRgNvNzIqL17m4AcUufgzb-opYELQ0_4L99Lui2jcV7v1LmKAy3Rzx5OLGhJpyITJotQHlukZ_tQtSKOqv5QiIJltOwezqmpuNt-d6F_gri7hEqQ6sPk-kEP_rkpDq844KAUwAQ; kuaishou.shop.b_ph=3b9b2d2104628309b0ba12391c3a60a7b8a4")))
...
if __name__ == '__main__':
    ...
    if args.one:
        ...
        now = datetime.now()
        scheduler.add_job(auto_pub, 'interval', minutes=2, max_instances=1, next_run_time=now)
        scheduler.start()
